...
本專案 fork 自 Will 保哥開發的開源專案 [doggy8088/codex-reset-checker](https://github.com/doggy8088/codex-reset-checker)，沿用 MIT License。
主要定位為 **Windows-first 維護型 fork**，提供可重現的 Windows 開發環境驗收門禁、繁體中文維護入口文件與上游變更追蹤。上游原版說明請見 [README.en.md](README.en.md)，fork 維護取捨與差異清單見 [FORK.md](FORK.md)。

> [!NOTE]
> 本 fork 保留所有原始功能、邏輯與測試，聚焦於 Windows 11 原生 PowerShell 開發體驗，絕不向第三方或上游未授權發佈。
